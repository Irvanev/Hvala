...
import {
  fetchAdvertismentsSearch,
  fetchAdvertisments,
  fetchAdditionalAdvertisements,
  fetchAdvertismentsByFilters,
} from "../../services/AdvertismentsHome/AdvertismentsService";
...
export const Advertisement = () => {
  ...
  const loadMoreAdvertisements = async () => {
    ...
    if (additionalAdvertisements.length > 0) {
      setAdvertisement((prevAdvertisements) => [
        ...prevAdvertisements,
        ...additionalAdvertisements,
      ]);
      setLoadedAdvertisements(
        (prevLoaded) => prevLoaded + additionalAdvertisements.length
      );
    } else {
          ...
          <Container className="album mt-3">
            {isTimeout ? (
              ...
              <Row xs={2} sm={2} md={3} lg={4} className="g-3">
                ...
                ).map((advertisment, index) => (
                  <CardAdvertisementHome
                    key={index}
          ...
          {loadMoreButtonVisible && (
            <div className="text-center mt-3">
              <button
                ...
                onClick={loadMoreAdvertisements}
              >
                {t("show_more")}
              </button>
            </div>
