...
import SelectBrandsForComputersAccs from "../../select-brands/SelectBrandsForComputersAccs";
import SelectTypesForComputersAccs from "../../select-types/select-types-electronics/SelectTypesForComputersAccs";
