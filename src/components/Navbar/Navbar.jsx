                ...
                <div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-customColor1 border-t rounded-t-2xl border-gray-200">
                    <div class="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
                        <button onClick={handleHomeClick} type="button" className="inline-flex flex-col items-center justify-center px-4 group е">
                            ...
                            <span class={`text-xs text-customColor3  group-hover:text-customColor2 ${getButtonStyle('/advertisment')}`}>{t("home_navbar")}</span>
                        </button>
                        <button onClick={handleSettingsClick} type="button" class="inline-flex flex-col items-center justify-center px-4 border-gray-200 group dark:border-gray-600">
                            ...
                            <span class={`text-xs text-customColor3  group-hover:text-customColor2 ${getButtonStyle('/settings')}`}>{t("settings")}</span>
                        </button>


                        <button onClick={handleAddItemClick} type="button" class="inline-flex flex-col items-center justify-center px-4 group">
                            ...
                            <span class={`text-xs text-customColor3  group-hover:text-customColor2 ${getButtonStyle('/addItem')}`}>{t("addItem_navbar")}</span>
                        </button>


                        <button onClick={handleMessageClick} type="button" class="inline-flex flex-col items-center justify-center px-4 group">
                            ...
                            <span class={`text-xs text-customColor3  group-hover:text-customColor2 ${getButtonStyle('/message')}`}>{t("message_navbar")}</span>
                        </button>

                        <button onClick={handleProfileClick} type="button" class="inline-flex flex-col items-center justify-center px-4 border-gray-200 group dark:border-gray-600">
                            ...
                            <span class={`text-xs text-customColor3  group-hover:text-customColor2 ${getButtonStyle('/profile')}`}>{t("profile_navbar")}</span>
                        </button>
                    </div>
                </div>
